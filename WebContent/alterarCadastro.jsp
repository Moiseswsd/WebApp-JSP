...
<body>
	<div class="titulo">
		<h1 class="texto">Alterar dados</h1>
	</div>	
	<div class="formCad">
	<form action="altCadastro" name="cadastro" onsubmit="return validarCadastro();">
		...
		<select name="cargo" id="cargo" class="form-select">
			<option value="<%=pessoa.getCargoID()%>" selected><%=pessoa.getCargo().getCargo()%></option>
		</select>
		<br/>
