...
<body>
	<div class="titulo">
		<h1 class="texto">Criando novo cadastro!</h1>
	</div>	
<a href="diretor.jsp" class="btn btn-info" id="botaoSair">Início</a>
	<div class="formCad">
	<form action="criar" name="cadastro" onsubmit="return validarCadastro();"> 
	...
	<%if(session.getAttribute("info") != null){ session.setAttribute("info", null);%> <p id="msg">Login/CPF já está sendo utilizado!</p> <% } %>
