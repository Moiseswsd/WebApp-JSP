<%@page import="model.VerificaLoginProfessor"%>
...
<% Pessoa pessoa = (Pessoa)session.getAttribute("pessoa");
	VerificaLoginProfessor vlp = new VerificaLoginProfessor();
	vlp.verificaLogin(session, request, response);	%>
</head>
<body>
<img alt="imagemProf" src="imagens/prfo.png">
	<div class="titulo">
		<h1 class="texto">Bem vindo(a), Professor <%=pessoa.getNome().toUpperCase() %>!</h1>
	</div>	
	<div class="formCad">
