...
<body>
		<img alt="imagemDiretor" src="imagens/direc.png">
	
	<div class="titulo">	
		<h1 class="texto">Bem vindo(a), Diretor(a) <%=pessoa.getNome().toUpperCase()%>!</h1>
	</div>	
	...
	<a href="obtemTodos" id="link" class="btn btn-success">Todos os cadastros</a>
